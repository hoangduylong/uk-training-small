...
public class JobTitleTraining extends AggregateRoot {
	 ...
	 */
	public JobTitleTraining(PositionCodeTraining position, JobTitleCodeTraining jobCode,
			List<HistoryTraining> historyTraining, boolean isAbrogated, boolean treatAsAManager) {
		super();
...
//	methods
	 ...
	 * @return JobTitle
	 */
	public static JobTitleTraining createFromJavaType(String positionCode, String jobTitleCode,
			List<HistoryTraining> historyTraining, boolean abrogated, boolean treatAsAManager) {
		return new JobTitleTraining(new PositionCodeTraining(positionCode), new JobTitleCodeTraining(jobTitleCode),
				historyTraining, abrogated, treatAsAManager);
	}
}