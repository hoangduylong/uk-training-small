        ...
        (function (ui) {
            ...
            (function (gridlist) {
                __viewContext.ready(function () {
                    ...
                    var newComboItems1 = [new ItemModel("4", "NewText4"),
                        new ItemModel("5", "NewText5"),
                        new ItemModel("6", "NewText6"),
                        new ItemModel("7", "NewText7")];
                    var newComboItems2 = [new ItemModel("7", "NewText7"),
                    ...
                    function inputProcess(id, item, value) {
                        var dfd = $.Deferred();
                        var data = { id: id, item: item, value: value };
                        ui.block.grayout();
                        uk.request.ajax("/sample/lazyload/process", data).done(function (d) {
                            setTimeout(function () {
                                dfd.resolve(d);
                                ui.block.clear();
                            }, 2000);
