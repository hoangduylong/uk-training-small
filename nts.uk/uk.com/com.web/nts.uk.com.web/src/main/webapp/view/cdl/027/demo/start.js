                    ...
                    (function (demo) {
                        ...
                        var ScreenModel = /** @class */ (function () {
                            function ScreenModel() {
                                this.displayFormat = ko.observable(0);
                                this.selectedEmployee = ko.observableArray([]);
                                this.period = ko.observable({});
                                this.yearMonth = ko.observable(null);
                                this.date = ko.observable(null);
                                this.functionId = ko.observable(1);
                                this.displayFormats = ko.observableArray([{ code: 0, name: '日付別' }, { code: 1, name: '個人別' }]);
                                this.functionIDs = ko.observableArray([
                                    { name: 'スケジュール', code: 1 },
                                    { name: '日次', code: 2 },
                                    { name: '月次', code: 3 },
                                    { name: '任意期間', code: 4 },
                                ...
                                this.monthlyChecked = ko.observable(false);
                                ...
                                var self = this;
                                self.periodType = ko.computed(function () {
                                ...
                                self.periodType.subscribe(function (value) {
                                    if (value != "yearmonth")
                                        self.monthlyChecked(false);
                                });
                            }
                            ScreenModel.prototype.openCdl027Dialog = function () {
