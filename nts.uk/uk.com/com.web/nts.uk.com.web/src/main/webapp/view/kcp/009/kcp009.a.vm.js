        ...
        (function (viewmodel) {
            ...
            var ScreenModel = /** @class */ (function () {
                function ScreenModel() {
                    ...
                    self.isDisplayOrganizationName.subscribe(function (value) {
                        self.reloadComponent();
                    });
                    self.setBaseDate = ko.observable(true);
                    self.setBaseDate.subscribe(function (value) {
                        self.reloadComponent();
                    });
                    ...
                    self.isDisplayNumberOfEmployee.subscribe(function () { return self.reloadComponent(); });
...
//# sourceMappingURL=kcp009.a.vm.js.map