                ...
                (function (cps017) {
                    ...
                    (function (b) {
                        __viewContext.ready(function () {
                            __viewContext["viewModel"] = new b.viewmodel.ScreenModel();
...
function checkBox() {
    ...
    var source = ko.toJS(__viewContext["viewModel"].listSelection);
    ...
    $('#item_register_grid2').on("click", ".checkRow.initSelection", function (evt, ui) {
        var _this = $(this), data = ko.toJS(__viewContext["viewModel"].listSelection);
...
//# sourceMappingURL=cps017.b.start.js.map